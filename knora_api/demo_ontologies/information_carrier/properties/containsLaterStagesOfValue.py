...
"""
definition of property information-carrier:ContainsLaterStagesOfValue
...
class ContainsLaterStagesOfValue(HasLinkToValue):
    """
    ...
    def __init__(self, argument):
        ...
        self._name = "containsLaterStagesOfValue"
