...
class Cache(object):
    ...
    def initialize(self):
        ...
        try:
            ...
            cur.execute("CREATE TABLE Cache(key text PRIMARY KEY , value text NOT NULL);")
            cur.close()
    ...
    def set(self, key, value):
        ...
        try:
            cur = self._connection.cursor()
            cur.execute("INSERT INTO Cache VALUES (:key, :value);", {'key': key, 'value': value})
            self._connection.commit()
            return True
        except Exception as e:
            print(e)
    ...
    def setnx(self, key, value):
        """
        sets a key and it value, only if the key does not exists
        :param key:
        :param value:
        :return:
        """
